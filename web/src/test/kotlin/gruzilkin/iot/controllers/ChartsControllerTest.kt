...
class ChartsControllerTest {
    ...
    fun index() {
        ...
        sensorDataService.saveSensorData(SensorDataEvent(device.id!!, "temperature", BigDecimal.valueOf(1), 1))
        sensorDataService.saveSensorData(SensorDataEvent(device.id!!, "temperature", BigDecimal.valueOf(2), 2))
